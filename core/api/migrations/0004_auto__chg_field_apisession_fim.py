...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ApiSession.fim'
        db.alter_column(u'api_apisession', 'fim', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'ApiSession.fim'
        db.alter_column(u'api_apisession', 'fim', self.gf('django.db.models.fields.DateTimeField')(default=''))
