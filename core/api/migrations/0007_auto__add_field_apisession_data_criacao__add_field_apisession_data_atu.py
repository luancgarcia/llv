...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApiSession.data_criacao'
        db.add_column(u'api_apisession', 'data_criacao',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ApiSession.data_atualizacao'
        db.add_column(u'api_apisession', 'data_atualizacao',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApiSession.data_criacao'
        db.delete_column(u'api_apisession', 'data_criacao')

        # Deleting field 'ApiSession.data_atualizacao'
        db.delete_column(u'api_apisession', 'data_atualizacao')
