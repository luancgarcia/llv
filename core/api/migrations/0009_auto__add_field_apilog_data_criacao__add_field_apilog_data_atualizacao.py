...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApiLog.data_criacao'
        db.add_column(u'api_apilog', 'data_criacao',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ApiLog.data_atualizacao'
        db.add_column(u'api_apilog', 'data_atualizacao',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApiLog.data_criacao'
        db.delete_column(u'api_apilog', 'data_criacao')

        # Deleting field 'ApiLog.data_atualizacao'
        db.delete_column(u'api_apilog', 'data_atualizacao')
