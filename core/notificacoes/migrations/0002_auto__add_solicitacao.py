...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notificacoes_solicitacao', (
            ...
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=250, null=True)),
            ('loja', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='solicitacoes', null=True, to=orm['lojas.Loja'])),
        ))
        db.send_create_signal(u'notificacoes', ['Solicitacao'])


    def backwards(self, orm):
        # Deleting model 'Solicitacao'
        db.delete_table(u'notificacoes_solicitacao')
