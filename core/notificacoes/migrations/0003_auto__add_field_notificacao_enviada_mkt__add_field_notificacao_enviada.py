...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notificacao.enviada_mkt'
        db.add_column(u'notificacoes_notificacao', 'enviada_mkt',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Notificacao.enviada_lojista'
        db.add_column(u'notificacoes_notificacao', 'enviada_lojista',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
