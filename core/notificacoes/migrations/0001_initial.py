...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notificacoes_notificacao', (
            ...
            ('mensagem', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('lida', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('resolvida', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('oferta', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notificacoes', null=True, to=orm['geral.Oferta'])),
            ('solicitante', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='solicitante', null=True, to=orm['geral.Perfil'])),
            ('responsavel', self.gf('django.db.models.fields.related.ForeignKey')(related_name='responsavel', null=True, to=orm['geral.Perfil'])),
        ))
        db.send_create_signal(u'notificacoes', ['Notificacao'])


    def backwards(self, orm):
        # Deleting model 'Notificacao'
        db.delete_table(u'notificacoes_notificacao')
