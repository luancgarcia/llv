...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Oferta.shopping'
        db.add_column(u'geral_oferta', 'shopping',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lojas.Shopping'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oferta.shopping'
        db.delete_column(u'geral_oferta', 'shopping_id')
