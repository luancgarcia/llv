...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Perfil'
        db.create_table(u'geral_perfil', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='perfil', to=orm['auth.User'])),
            ('loja', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='usuarios', null=True, to=orm['lojas.Loja'])),
        ))
        db.send_create_signal(u'geral', ['Perfil'])


    def backwards(self, orm):
        # Deleting model 'Perfil'
        db.delete_table(u'geral_perfil')
