...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Categoria', fields ['shopping', 'slug']
        db.create_unique(u'geral_categoria', ['shopping_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Categoria', fields ['shopping', 'slug']
        db.delete_unique(u'geral_categoria', ['shopping_id', 'slug'])
