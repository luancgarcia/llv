...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Categoria.default'
        db.delete_column(u'geral_categoria', 'default')

        # Adding field 'Categoria.sazonal'
        db.add_column(u'geral_categoria', 'sazonal',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Categoria.default'
        db.add_column(u'geral_categoria', 'default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Categoria.sazonal'
        db.delete_column(u'geral_categoria', 'sazonal')
