...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Perfil.shopping'
        db.add_column(u'geral_perfil', 'shopping',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='usuarios', null=True, to=orm['lojas.Shopping']),
                      keep_default=False)

        # Adding field 'Perfil.tipo'
        db.add_column(u'geral_perfil', 'tipo',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Perfil.shopping'
        db.delete_column(u'geral_perfil', 'shopping_id')

        # Deleting field 'Perfil.tipo'
        db.delete_column(u'geral_perfil', 'tipo')
