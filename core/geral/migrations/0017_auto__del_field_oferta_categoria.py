...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'geral_oferta', 'categoria_id')

        # Adding M2M table for field categoria on 'Oferta'
        m2m_table_name = db.shorten_name(u'geral_oferta_categoria')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('oferta', models.ForeignKey(orm[u'geral.oferta'], null=False)),
            ('categoria', models.ForeignKey(orm[u'geral.categoria'], null=False))
        ))
        db.create_unique(m2m_table_name, ['oferta_id', 'categoria_id'])


    def backwards(self, orm):
        # Adding field 'Oferta.categoria'
        db.add_column(u'geral_oferta', 'categoria',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='ofertas', null=True, to=orm['geral.Categoria'], blank=True),
                      keep_default=False)

        # Removing M2M table for field categoria on 'Oferta'
        db.delete_table(db.shorten_name(u'geral_oferta_categoria'))
    ...
    models = {
        ...
        u'geral.mascara': {
            ...
            'categoria': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'data_atualizacao': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_criacao': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagem': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
