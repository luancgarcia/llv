...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CupomLoja'
        db.create_table(u'geral_cupomloja', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('data_criacao', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('data_atualizacao', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, null=True, blank=True)),
            ('cupom', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cupons', to=orm['geral.Oferta'])),
            ('loja', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cupons', to=orm['lojas.Loja'])),
            ('codigo', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'geral', ['CupomLoja'])


    def backwards(self, orm):
        # Deleting model 'CupomLoja'
        db.delete_table(u'geral_cupomloja')
    ...
    models = {
        ...
        u'geral.cupomloja': {
            'Meta': {'object_name': 'CupomLoja'},
            'codigo': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'cupom': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cupons'", 'to': u"orm['geral.Oferta']"}),
            'data_atualizacao': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'data_criacao': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'loja': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cupons'", 'to': u"orm['lojas.Loja']"})
        },
        ...
        u'geral.oferta': {
            ...
            'subtipo': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
