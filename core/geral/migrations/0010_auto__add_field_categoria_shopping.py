...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Categoria.shopping'
        db.add_column(u'geral_categoria', 'shopping',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='usuarios', null=True, to=orm['lojas.Shopping']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Categoria.shopping'
        db.delete_column(u'geral_categoria', 'shopping_id')
