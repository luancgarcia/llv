...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mascara.categoria'
        db.add_column(u'geral_mascara', 'categoria',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='mascaras', null=True, to=orm['geral.Categoria']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mascara.categoria'
        db.delete_column(u'geral_mascara', 'categoria_id')
    ...
    models = {
        ...
        u'geral.mascara': {
            ...
            'categoria': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mascaras'", 'null': 'True', 'to': u"orm['geral.Categoria']"}),
            'data_atualizacao': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'data_criacao': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagem': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
