...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Oferta.autor'
        db.add_column(u'geral_oferta', 'autor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geral.Perfil'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oferta.autor'
        db.delete_column(u'geral_oferta', 'autor_id')
