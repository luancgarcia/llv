...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Oferta.texto_promocional'
        db.alter_column(u'geral_oferta', 'texto_promocional', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

    def backwards(self, orm):

        # Changing field 'Oferta.texto_promocional'
        db.alter_column(u'geral_oferta', 'texto_promocional', self.gf('django.db.models.fields.TextField')(null=True))
