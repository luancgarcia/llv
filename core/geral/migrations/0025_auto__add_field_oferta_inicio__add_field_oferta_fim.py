...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Oferta.inicio'
        db.add_column(u'geral_oferta', 'inicio',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Oferta.fim'
        db.add_column(u'geral_oferta', 'fim',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oferta.inicio'
        db.delete_column(u'geral_oferta', 'inicio')

        # Deleting field 'Oferta.fim'
        db.delete_column(u'geral_oferta', 'fim')
