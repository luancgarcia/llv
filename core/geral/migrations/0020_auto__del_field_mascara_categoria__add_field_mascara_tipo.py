...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'geral_mascara', 'categoria')

        # Adding field 'Mascara.tipo'
        db.add_column(u'geral_mascara', 'tipo',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Mascara.tipo'
        db.delete_column(u'geral_mascara', 'tipo')
