...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Oferta.slug'
        db.alter_column(u'geral_oferta', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=250, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Oferta.slug'
        db.alter_column(u'geral_oferta', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=250, unique=True))
